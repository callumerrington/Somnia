...
public class Somnia
{
	...
	/*
	 * These methods were referenced by ASM generated bytecode
	 * 
	*/
		...
		if (proxy.disableCreatureSpawning)
		{
			for (ServerTickHandler serverTickHandler : instance.tickHandlers)
			{
				if (serverTickHandler.worldServer == worldServer)
					return !serverTickHandler.mbCheck && MinecraftServer.getServer().worldServerForDimension(0).getGameRules().getGameRuleBooleanValue("doMobSpawning");
			}
		}
